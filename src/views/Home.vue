  ...
  <div class="row align-items-md-stretch">
    <div class="col-md-6 mb-4">
      <div class="h-100 p-5 text-white bg-dark border rounded-3">
        <h2>{{ msg }}</h2>
        <p>Before getting started with Bootstrap’s modal component, be sure to read the following as our menu options have
          recently changed.</p>
        <ul>
          <li>
          ...
          <li>Bootstrap only supports one modal window at a time. Nested modals aren’t supported as we believe them to be
            poor user experiences.</li>
          <li>
            Modals use
            <code class="highlighter-rouge">position: fixed</code>
            , which can sometimes be a bit particular about its rendering. Whenever possible, place your modal HTML in a
            top-level position to avoid potential interference from other elements. You’ll likely run into issues when
            nesting a
          ...
          <li>
            ...
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-autofocus" target="_blank"
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <button @click="state.count++" class="btn btn-primary text-uppercase">You clicked me {{ state.count }}
                  time{{ state.count === 1 ? "" : "s" }}</button>
              </div>
    ...
    <div class="col-md-6 mb-4">
      <div class="p-5 box border rounded-3 mb-4">
        ...
        <button type="button" class="btn btn-primary" @click="toast.show()">Show Toast</button>
